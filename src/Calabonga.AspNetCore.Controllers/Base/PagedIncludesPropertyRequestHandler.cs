...
namespace Calabonga.AspNetCore.Controllers.Base
{
        ...
        where TEntity : Identity
    {
        ...
        /// <returns></returns>
        public virtual Expression<Func<TEntity, bool>> FilterItems(Expression<Func<TEntity, bool>> predicate, TQueryParams queryParams)
        {
            return predicate;
        }
        ...
        /// <returns></returns>
        public virtual OperationResult<IPagedList<TResponse>> OperationResultBeforeReturn(OperationResult<IPagedList<TResponse>> operationResult)
        {
