...
namespace Calabonga.AspNetCore.Controllers.Handlers
{
    /// <summary>
        ...
        where TUpdateViewModel : ViewModelBase, new()
    {
        ...
        /// <returns></returns>
        public virtual OperationResult<TViewModel> OperationResultBeforeReturn(HandlerStep result, OperationResult<TViewModel> operationResult)
        {
        ...
        public virtual Task<HandlerStep> OnUpdateAfterSaveChangesFailedAsync(HandlerStep step)
        {
        ...
        /// </summary>
        /// <param name="step"></param>
        public virtual Task<HandlerStep> OnUpdateBeforeSaveChangesAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </summary>
        /// <param name="step"></param>
        public virtual Task<HandlerStep> OnUpdateBeforeAnyValidationsAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </summary>
        /// <param name="step"></param>
        public virtual Task<HandlerStep> OnUpdateBeforeMappingsAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        /// <param name="step"></param>
        /// <returns></returns>
        public virtual Task<HandlerStep> OnUpdateAfterSaveChangesSuccessAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        public async Task<OperationResult<TViewModel>> Handle(PutItemQuery<TEntity, TViewModel, TUpdateViewModel> request, CancellationToken cancellationToken)
        {
            ...
            if (!step6.IsStopped) return OperationResultBeforeReturn(step6, operation);
            await transaction.RollbackAsync(cancellationToken);
        ...
        /// <returns></returns>
        public virtual Task<TEntity> FindEntity(TUpdateViewModel model)
        {
            return UnitOfWork.GetRepository<TEntity>().GetFirstOrDefaultAsync(predicate: x => x.Id == model.Id);
        }
        ...
        /// <returns></returns>
        protected virtual OperationResult<TViewModel> ProcessOperationResult(OperationResult<TViewModel> operationResult, TViewModel response)
        {
            return null;
        }
    }
