...
using Calabonga.AspNetCore.Controllers.CreateSteps;
...
namespace Calabonga.AspNetCore.Controllers.Handlers
{
        ...
        where TCreateViewModel : class, IViewModel, new()
    {
        ...
        /// <returns></returns>
        protected virtual Task<HandlerStep> OnCreateBeforeMappingAsync(HandlerStep step)
        {
        ...
        /// </summary>
        /// <param name="step"></param>
        protected virtual Task<HandlerStep> OnCreateBeforeAnyValidationsAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </summary>
        /// <param name="step"></param>
        protected virtual Task<HandlerStep> OnCreateBeforeSaveChangesAsync(HandlerStep step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </summary>
        /// <param name="step"></param>
        protected virtual Task<HandlerResult> OnCreateAfterSaveChangesSuccessAsync(HandlerResult step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </summary>
        /// <param name="step"></param>
        protected virtual Task<HandlerResult> OnCreateAfterSaveChangesFailedAsync(HandlerResult step)
        {
            return Task.FromResult(step);
        }
        ...
        /// </param>
        /// <returns></returns>
        protected virtual OperationResult<TViewModel> OperationResultBeforeReturn(HandlerStep step, OperationResult<TViewModel> operationResult)
        {
